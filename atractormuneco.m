...
%Partiendo de x1=-0.01 y=-0.01 se forma un muñeco con cabeza, brazos y
%piernas.
...
%otro dentro de esa misma órbita tancerca del anterior  como
...
for i=1:iter
    ...
    y1=yn;
    hold on
    plot(xn,yn,'k','markersize',2) %Markersize 2 para cambiar tamaño de los ptos.
    pause(0.00001)
end